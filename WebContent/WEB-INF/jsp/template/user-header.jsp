		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					<li class="active"><a href="index" title="我关注的日志"><span
							class="glyphicon glyphicon-home"></span> 首页</a></li>
					<li><a href="find" title="所有日志"><span class="glyphicon glyphicon-eye-open"></span>
							发现</a></li>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li>
								<a href="focusLog?thisPage=1"><span class="glyphicon glyphicon-heart"></span> 关注的日志</a></li>
						</ul>
					</li>
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="addlog" title="添加日志"><span
							class="glyphicon glyphicon-pencil"></span> 写日志</a></li>
