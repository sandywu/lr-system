		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<nav class="fenye" style="float: right;">
					<ul class="pagination">
						<li><a href="focusLog?thisPage=1">更多日志...</a></li>
					</ul>
				</nav>
				<!--分页部分结束-->
					</c:otherwise>
			...
			<div class="col-md-4">
				...
				<div class="btn-group" role="group">
					<a href="addlog" type="button" class="btn btn-default" title="写日志">写日志</a>
					...
					<a href="manageBlog" type="button" class="btn btn-default"
						title="管理日志本">管理日志本</a> <a href="TODOS" type="button"
				...
				<c:choose>
					<c:when test="${stmNumber != 0}">
						<hr />
						<h5>
							<a href="showStmMsg">
							<span class="glyphicon glyphicon-bell"></span> ${stmNumber}条系统通知
							</a>
						</h5>
					</c:when>
				</c:choose>
