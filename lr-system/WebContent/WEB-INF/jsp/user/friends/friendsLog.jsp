...
<c:choose>
	...
	<c:forEach items="${logs}" var="log">
		<div class="row" style="margin-top: 25px; padding-left: 20px;">
			...
			<a class="user" name="../me/friendsIndex?whoCreate=${log.whoCreate}"
			...
			<div style="margin-left:60px;">
				<h5>
					<label>${log.whoCreate}的日记:</label> <a class="user"
			...
			<div class="content">
				<c:choose>
					<c:when test="${fn:length(log.content) > 120}">
						<pre style="margin-left: 60px;">${fn:substring(log.content, 0, 120)} 
	...
	<nav class="fenye">
		<ul id="pagination" class="pagination">
			...
			<li id="first"><a href="./../me/friendsLog?thisPage=1&whoCreate=${logs[0].whoCreate}">1</a></li>
