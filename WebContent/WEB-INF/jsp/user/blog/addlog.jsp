				...
				<div class="control-group">
					<div class="input-group">
						...
						<input name="place" type="text" class="form-control"
							id="addlog_place" placeholder="写日志的地点..." />
					</div>
				</div>
				<div class="control-group">
					<div class="input-group">
						...
						<input name="title" type="text" class="form-control"
							id="addlog_title" placeholder="日志的标题..." required="required" />
					</div>
				</div>
				<div class="control-group">
					<span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>
					<small>由于使用火狐浏览器开发，强烈推荐使用火狐浏览器发布日志~</small>
				</div>
				<div class="control-group">
					<textarea name="content" id="textarea1" style="height:400px;" required="required"></textarea>
				</div>
				<div class="control-group">
					<label><input name="visible" type="checkbox" />&nbsp;仅自己可见</label>&nbsp;&nbsp;&nbsp;
					<label><input name="reply" type="checkbox" />&nbsp;不允许被回复</label>
				</div>
				<div class="control-group">
